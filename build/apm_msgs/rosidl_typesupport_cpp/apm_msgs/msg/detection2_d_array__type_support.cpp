...
static const _Detection2DArray_type_support_symbol_names_t _Detection2DArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, apm_msgs, msg, Detection2DArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, apm_msgs, msg, Detection2DArray)),
  }
};
...
{
  return &::apm_msgs::msg::rosidl_typesupport_cpp::Detection2DArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, apm_msgs, msg, Detection2DArray)() {
  return get_message_type_support_handle<apm_msgs::msg::Detection2DArray>();
}
