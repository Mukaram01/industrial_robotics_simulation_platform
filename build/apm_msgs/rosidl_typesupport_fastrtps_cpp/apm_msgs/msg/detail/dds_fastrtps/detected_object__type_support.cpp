...
#include "apm_msgs/msg/detail/detected_object__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = apm_msgs::msg::DetectedObject;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const apm_msgs::msg::DetectedObject *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<apm_msgs::msg::DetectedObject *>(
    untyped_ros_message);
...
{
  return &apm_msgs::msg::typesupport_fastrtps_cpp::_DetectedObject__handle;
}
