...
#include "apm_msgs/msg/detail/detection2_d_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const apm_msgs::msg::Detection2D &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  apm_msgs::msg::Detection2D &);
size_t get_serialized_size(
  const apm_msgs::msg::Detection2D &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const apm_msgs::msg::Detection2DArray & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: detections
  {
    ...
    for (size_t i = 0; i < size; i++) {
      apm_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  apm_msgs::msg::Detection2DArray & ros_message)
{
  // Member: header
  ...
  // Member: detections
  {
    ...
    for (size_t i = 0; i < size; i++) {
      apm_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        apm_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        apm_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Detection2D(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = apm_msgs::msg::Detection2DArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const apm_msgs::msg::Detection2DArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<apm_msgs::msg::Detection2DArray *>(
    untyped_ros_message);
...
{
  return &apm_msgs::msg::typesupport_fastrtps_cpp::_Detection2DArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, apm_msgs, msg, Detection2DArray)() {
  return &apm_msgs::msg::typesupport_fastrtps_cpp::_Detection2DArray__handle;
}
