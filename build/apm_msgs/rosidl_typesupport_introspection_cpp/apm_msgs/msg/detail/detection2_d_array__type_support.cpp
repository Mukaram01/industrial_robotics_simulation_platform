...
#include "apm_msgs/msg/detail/detection2_d_array__struct.hpp"
...
{
  new (message_memory) apm_msgs::msg::Detection2DArray(_init);
}

void Detection2DArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<apm_msgs::msg::Detection2DArray *>(message_memory);
  typed_message->~Detection2DArray();
}

size_t size_function__Detection2DArray__detections(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<apm_msgs::msg::Detection2D> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<apm_msgs::msg::Detection2D> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<apm_msgs::msg::Detection2D> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const apm_msgs::msg::Detection2D *>(
    get_const_function__Detection2DArray__detections(untyped_member, index));
  auto & value = *reinterpret_cast<apm_msgs::msg::Detection2D *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<apm_msgs::msg::Detection2D *>(
    get_function__Detection2DArray__detections(untyped_member, index));
  const auto & value = *reinterpret_cast<const apm_msgs::msg::Detection2D *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Detection2DArray_message_member_array[2] = {
  {
    ...
    offsetof(apm_msgs::msg::Detection2DArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<apm_msgs::msg::Detection2D>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(apm_msgs::msg::Detection2DArray, detections),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Detection2DArray_message_members = {
  "apm_msgs::msg",  // message namespace
  "Detection2DArray",  // message name
  2,  // number of fields
  sizeof(apm_msgs::msg::Detection2DArray),
...
get_message_type_support_handle<apm_msgs::msg::Detection2DArray>()
{
  return &::apm_msgs::msg::rosidl_typesupport_introspection_cpp::Detection2DArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, apm_msgs, msg, Detection2DArray)() {
  return &::apm_msgs::msg::rosidl_typesupport_introspection_cpp::Detection2DArray_message_type_support_handle;
}
