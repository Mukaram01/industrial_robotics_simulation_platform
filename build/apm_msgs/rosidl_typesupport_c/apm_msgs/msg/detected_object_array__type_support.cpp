...
static const _DetectedObjectArray_type_support_symbol_names_t _DetectedObjectArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, apm_msgs, msg, DetectedObjectArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, apm_msgs, msg, DetectedObjectArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, apm_msgs, msg, DetectedObjectArray)() {
  return &::apm_msgs::msg::rosidl_typesupport_c::DetectedObjectArray_message_type_support_handle;
}
