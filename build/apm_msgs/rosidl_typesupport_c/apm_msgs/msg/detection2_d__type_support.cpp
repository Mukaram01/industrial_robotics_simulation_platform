...
static const _Detection2D_type_support_symbol_names_t _Detection2D_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, apm_msgs, msg, Detection2D)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, apm_msgs, msg, Detection2D)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, apm_msgs, msg, Detection2D)() {
  return &::apm_msgs::msg::rosidl_typesupport_c::Detection2D_message_type_support_handle;
}
