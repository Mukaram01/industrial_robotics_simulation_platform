...
static const _DetectedObject_type_support_symbol_names_t _DetectedObject_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, apm_msgs, msg, DetectedObject)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, apm_msgs, msg, DetectedObject)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, apm_msgs, msg, DetectedObject)() {
  return &::apm_msgs::msg::rosidl_typesupport_c::DetectedObject_message_type_support_handle;
}
